...
const std::shared_ptr<Menu> Test_Menu::construct(std::shared_ptr<Graphics_Context> context, std::shared_ptr<Event_Handler> handler, std::weak_ptr<CustomClient> connection) {
    ...
    button->registerCallBack([connection](const Graphics_Context& context, const Event_Handler& handler, Button& button) {
    ...
    input_button->registerCallBack([field, connection](const Graphics_Context& context, const Event_Handler& handler, Button& button) mutable {
