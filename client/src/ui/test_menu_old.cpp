...
const std::unique_ptr<Menu> Test_Menu(std::shared_ptr<Graphics_Context> context, std::shared_ptr<Event_Handler> handler) {
    ...
    button_layout->placeUI_Element(new Text_Box(context, "Button Text", font, 15, font_color, ALIGN_X::CENTER, ALIGN_Y::CENTER), 0);
    Button* button = new Button(context, handler, button_layout, 0, true, false, SDL_Color({172, 43, 12, 125}));
    button->registerCallBack([](Graphics_Context* context, Event_Handler* handler, Button* button) {
    ...
    input_button_layout->placeUI_Element(new Text_Box(context, "Submit", font, 15, font_color, ALIGN_X::CENTER, ALIGN_Y::CENTER), 0);
    ...
    input_button->registerCallBack([field](Graphics_Context* context, Event_Handler* handler, Button* button) {
    ...
    pannel_layout->placeUI_Element(new Text_Box(context, large, font, 15, font_color, ALIGN_X::CENTER, ALIGN_Y::CENTER), 2);
